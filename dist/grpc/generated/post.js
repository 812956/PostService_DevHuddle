        ...
        return {
            ...
            userId: isSet(object.userId)
                ...
                : isSet(object.user_id)
                    ? globalThis.String(object.user_id)
                    : "",
            generateShort: isSet(object.generateShort)
                ? globalThis.Boolean(object.generateShort)
                : isSet(object.generate_short)
                    ? globalThis.Boolean(object.generate_short)
                    : false,
...
exports.ResolveShareLinkRequest = {
    ...
    fromJSON(object) {
        return {
            tokenOrShortId: isSet(object.tokenOrShortId)
                ? globalThis.String(object.tokenOrShortId)
                : isSet(object.token_or_short_id)
                    ? globalThis.String(object.token_or_short_id)
                    : "",
        };
    },
    toJSON(message) {
    ...
    fromJSON(object) {
        return {
            originalPostId: isSet(object.originalPostId)
                ? globalThis.String(object.originalPostId)
                : isSet(object.original_post_id)
                    ? globalThis.String(object.original_post_id)
                    : "",
            userId: isSet(object.userId)
                ? globalThis.String(object.userId)
                : isSet(object.user_id)
            ...
            visibility: isSet(object.visibility) ? globalThis.String(object.visibility) : "",
            sharedToUserId: isSet(object.sharedToUserId)
                ? globalThis.String(object.sharedToUserId)
                : isSet(object.shared_to_user_id)
                    ? globalThis.String(object.shared_to_user_id)
                    : undefined,
            idempotencyKey: isSet(object.idempotencyKey)
                ? globalThis.String(object.idempotencyKey)
                : isSet(object.idempotency_key)
    ...
    fromJSON(object) {
        return {
            ...
            addAttachmentIds: globalThis.Array.isArray(object?.addAttachmentIds)
                ...
                : globalThis.Array.isArray(object?.add_attachment_ids)
                    ? object.add_attachment_ids.map((e) => globalThis.String(e))
                    : [],
            removeAttachmentIds: globalThis.Array.isArray(object?.removeAttachmentIds)
                ...
                : globalThis.Array.isArray(object?.remove_attachment_ids)
                    ? object.remove_attachment_ids.map((e) => globalThis.String(e))
                    : [],
            idempotencyKey: isSet(object.idempotencyKey)
                ? globalThis.String(object.idempotencyKey)
                : isSet(object.idempotency_key)
...
exports.EditPostResponse = {
    ...
    fromJSON(object) {
        return {
            ...
            newVersionNumber: isSet(object.newVersionNumber)
                ? globalThis.Number(object.newVersionNumber)
                : isSet(object.new_version_number)
                    ? globalThis.Number(object.new_version_number)
                    : 0,
        };
    },
    toJSON(message) {
        ...
        return {
            ...
            attachmentIds: globalThis.Array.isArray(object?.attachmentIds)
                ...
                : globalThis.Array.isArray(object?.attachment_ids)
                    ? object.attachment_ids.map((e) => globalThis.String(e))
                    : [],
            editedAt: isSet(object.editedAt)
                ...
                : isSet(object.edited_at)
                    ...
                    : "",
            editedById: isSet(object.editedById)
                ? globalThis.String(object.editedById)
                : isSet(object.edited_by_id)
                    ? globalThis.String(object.edited_by_id)
                    : "",
        };
    },
    toJSON(message) {
